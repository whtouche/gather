...
function SessionCard({ session, onRevoke, isRevoking }: SessionCardProps) {
  ...
  return (
    <div className={`bg-white rounded-lg shadow p-6 ${session.isCurrent ? "ring-2 ring-blue-500" : ""}`}>
          ...
          {showConfirm ? (
            <div className="flex flex-col gap-2">
              ...
              <button
                ...
                disabled={isRevoking}
                className="px-3 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
            </div>
