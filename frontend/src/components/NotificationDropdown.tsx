    ...
    case "EVENT_CANCELLED":
      return (
        <div className="flex-shrink-0 w-8 h-8 bg-red-100 dark:bg-red-900 rounded-full flex items-center justify-center">
          <svg className="h-4 w-4 text-red-600 dark:text-red-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    case "EVENT_UPDATED":
      return (
        <div className="flex-shrink-0 w-8 h-8 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
          <svg className="h-4 w-4 text-blue-600 dark:text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    case "RSVP_RECONFIRM":
      return (
        <div className="flex-shrink-0 w-8 h-8 bg-amber-100 dark:bg-amber-900 rounded-full flex items-center justify-center">
          <svg className="h-4 w-4 text-amber-600 dark:text-amber-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function NotificationDropdown({ className = "" }: NotificationDropdownProps) {
  ...
  const handleNotificationClick = async (notification: Notification) => {
    ...
    if (notification.eventId && notification.event?.state !== "CANCELLED") {
        ...
        <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden z-50">
          ...
          <div className="max-h-96 overflow-y-auto">
            {isLoading ? (
              ...
              <div className="px-4 py-8 text-center">
                <svg
                  className="h-12 w-12 text-gray-300 dark:text-gray-600 mx-auto"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div>
                {notifications.map((notification) => (
                  <button
                    ...
                    className={`w-full px-4 py-3 flex items-start gap-3 text-left hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors ${
