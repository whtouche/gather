  ...
  if (state === "loading") {
    return (
      <div className="bg-white rounded-xl shadow-sm p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">SMS Invitations</h3>
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm overflow-hidden">
      <div className="p-4 border-b border-gray-100">
        <h3 className="text-lg font-semibold text-gray-900">SMS Invitations</h3>
      </div>
      ...
      {/* Quota info */}
      {quota && (
        <div className="p-3 bg-blue-50 border-b border-gray-100 text-sm text-center">
            ...
            {invitations.map((inv) => (
              <tr key={inv.id} className="hover:bg-gray-50">
                <td className="px-4 py-3">
                  ...
                  <div className="text-xs text-gray-500 font-mono">{inv.phone}</div>
                </td>
                <td className="px-4 py-3">
                  <span
