    ...
    <div className="bg-white rounded-lg shadow p-4">
      ...
      <div className="space-y-3">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <label htmlFor="muteAll" className="font-medium text-gray-900 text-sm">
        ...
        {!settings.muteAll && (
          <div className="flex items-start ml-6 border-l-2 border-gray-200 pl-4">
            <div className="flex items-center h-5">
              <input
                type="checkbox"
                id="muteWallOnly"
            ...
            <div className="ml-3">
              <label htmlFor="muteWallOnly" className="font-medium text-gray-900 text-sm">
