    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
      ...
      <div className="p-4 border-b border-gray-100 dark:border-gray-700">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Mass Email History</h3>
          {quota && (
              ...
              {expandedId === message.id && (
                <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                  ...
                  <div className="grid grid-cols-4 gap-4 mt-4">
                    ...
                    <div className={`rounded-lg p-3 text-center ${message.openedCount > 0 ? 'bg-purple-50 dark:bg-purple-900/30' : 'bg-gray-50 dark:bg-gray-900/50'}`}>
                      <div className={`text-2xl font-bold ${message.openedCount > 0 ? 'text-purple-600 dark:text-purple-400' : 'text-gray-400 dark:text-gray-500'}`}>
                        {message.openedCount}
                      </div>
                      <div className={`text-xs ${message.openedCount > 0 ? 'text-purple-600 dark:text-purple-400' : 'text-gray-400 dark:text-gray-500'}`}>Opened</div>
                    </div>
