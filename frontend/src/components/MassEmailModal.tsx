          ...
          <div className="p-4 overflow-y-auto flex-1">
            ...
            {state === "preview" && (
              <div>
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-3 whitespace-pre-wrap text-gray-900">
                    {body}
                  </div>
                </div>
                    ...
                    <div className="border border-gray-200 rounded-lg divide-y divide-gray-100">
                      {recipientPreview.preview.map((recipient, index) => (
                        <div key={index} className="px-3 py-2 flex items-center justify-between">
                          ...
                          <span className="text-xs text-gray-500 font-mono">{recipient.email}</span>
                        </div>
                      ))}
                    </div>
            ...
            {state === "sending" && (
              <div className="py-12 text-center">
                ...
                <p className="mt-4 text-gray-600">Sending message to {recipientPreview?.count} recipient(s)...</p>
              </div>
            )}
